...
interrupt trigger type"]
pub type SOURCE_W<'a, const O: u8> = crate::BitWriter<'a, u32, TRIGGER_SPEC, SOURCE_A, O>;
impl<'a, const O: u8> SOURCE_W<'a, O> {
    #[doc = "Level Triggered"]
    #[inline(always)]
    pub fn level(self) -> &'a mut W {
        self.variant(SOURCE_A::LEVEL)
    }
    #[doc = "Edge Triggered"]
    #[inline(always)]
    pub fn edge(self) -> &'a mut W {
        self.variant(SOURCE_A::EDGE)
    }
}
impl R {
    #[doc = "Source\\[i\\]
...
#[doc = "`reset()` method sets TRIGGER%s to value 0"]
