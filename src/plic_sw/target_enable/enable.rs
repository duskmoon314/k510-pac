...
impl SOURCE_R {
    ...
    pub fn variant(&self) -> SOURCE_A {
        match self.bits {
            false => SOURCE_A::DISABLED,
            true => SOURCE_A::ENABLED,
        }
    }
    #[doc = "Checks if the value of the field is `DISABLED`"]
    #[inline(always)]
    pub fn is_disabled(&self) -> bool {
        *self == SOURCE_A::DISABLED
    }
    #[doc = "Checks if the value of the field is `ENABLED`"]
    #[inline(always)]
    pub fn is_enabled(&self) -> bool {
        *self == SOURCE_A::ENABLED
    }
}
#[doc = "Fields `SOURCE(0-31)` writer - SOURCE\\[i\\]
enable status"]
pub type SOURCE_W<'a, const O: u8> = crate::BitWriter<'a, u32, ENABLE_SPEC, SOURCE_A, O>;
impl<'a, const O: u8> SOURCE_W<'a, O> {
    #[doc = "Target\\[i\\]
is disabled"]
    #[inline(always)]
    pub fn disabled(self) -> &'a mut W {
        self.variant(SOURCE_A::DISABLED)
    }
    #[doc = "Target\\[i\\]
is enabled"]
    #[inline(always)]
    pub fn enabled(self) -> &'a mut W {
        self.variant(SOURCE_A::ENABLED)
    }
}
impl R {
    #[doc = "SOURCE\\[i\\]
...
#[doc = "`reset()` method sets ENABLE%s to value 0"]
