...
#[doc = "Field `THR` writer - Transmit Holding Register"]
pub type THR_W<'a> = crate::FieldWriter<'a, u32, UART_THR_SPEC, u16, u16, 9, 0>;
impl W {
    #[doc = "Bits 0:8 - Transmit Holding Register"]
    #[inline(always)]
